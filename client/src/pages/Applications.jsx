...
const Applications = () => {
    ...
    const {fetchUserData,backendUrl,userData,userApplications,fetchUserApplications} = useContext(AppContext)
    ...
    const updateResume = async() =>{
        ...
        try {
            ...
            const {data} = await axios.post(backendUrl+'/api/users/upload-resume',formData,{headers:{Authorization:`Bearer ${token}`}})
